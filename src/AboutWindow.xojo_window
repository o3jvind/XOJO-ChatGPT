...
Begin DesktopWindow AboutWindow
   ...
   Visible         =   True
   Width           =   660
   Begin DesktopTextArea AboutTextArea
      ...
      Width           =   660
   End
   Begin DesktopTextField ApiKeyTextField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
...
#tag Events ApiKeyTextField
	#tag Event
		Sub Opening()
		  Me.Text = Preferences.ApiKey
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events OKButton
	#tag Event
		Sub Pressed()
		  Preferences.ApiKey = ApiKeyTextField.Text
